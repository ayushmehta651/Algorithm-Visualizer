export function getMergeSortAnimations(array) {
  ...
  doMergeSort(auxillaryArray, 0, auxillaryArray.length - 1, animations);
...
function doMergeSort(auxillaryArray, startIndex, endIndex, animations) {
  if(startIndex === endIndex)
      return;
  const middleIndex = Math.floor((startIndex + endIndex)/2);
  doMergeSort(auxillaryArray, startIndex, middleIndex, animations);
  doMergeSort(auxillaryArray, middleIndex + 1, endIndex, animations);
